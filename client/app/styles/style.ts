export const styles = {
    ...
    label:"text-[16px] text-black dark:text-white font-[400] font-Poppins py-2",
    input:"w-full text-black dark:text-white bg-transparent border rounded h-[40px] px-2 outline-nonemt-[10px] font-Poppins",
