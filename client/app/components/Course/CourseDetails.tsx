    ...
    <div>
      <div className="w-[90%] 800px:w-[90%] m-auto py-5">
          ...
          <div className="w-full 800px:w-[65%] 800px:pr-5">
            ...
            <div className="w-full">
              <div className="800px:flex items-center">
                <Ratings rating={data?.ratings} />
                <div className="ml-2 mb-2 800px:mb-[unset]">
                    ...
                    <div key={index} className="w-full pb-4">
                      <div className="flex">
                        ...
                        <div className="hidden 800px:block pl-2">
                          ...
                          <small className="text-black dark:text-white">{format(item.createdAt)}</small>
                        </div>
                        <div className=" items-center 800px:hidden pl-2">
                          <h5 className="text-[18px] text-black dark:text-white">{item.user.name}</h5>
                          <Ratings rating={item.rating} />
                        </div>
                      </div>
                    </div>
        ...
        <div className="w-full 800px:w-[35%] relative">
            <div className="w-full sticky top-[100px] left-0 z-50">
                <CoursePlayer
                videoUrl={data?.demoUrl}
                title={data?.title}
                />
                <div className="flex items-center">
                    <h1 className=" pt-5 text-[25px]  text-black dark:text-white flex items-center">
